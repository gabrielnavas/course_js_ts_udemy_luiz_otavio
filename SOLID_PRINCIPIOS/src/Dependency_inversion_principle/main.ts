...
const individualCustomer = new IndividualCustomer('Gabriel', 'Navas', '111.111.111-11')
const enterpriseCustomer = new EnterpriseCustomer('Empresa X', '222222222222')
const order = new Order(shopCart, sendMessage, persistencyCart, enterpriseCustomer)
